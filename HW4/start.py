...
df['text_desc_headline_url'] = df['short_description'] + \
    ' ' + df['headline']+" " + df['tokenized_url']
...
def extract_features(df, field, training_data, testing_data, type="binary"):
    ...
    if "binary" in type:
        ...
        train_feature_set = tfidf_vectorizer.transform(
            training_data[field].values)
        test_feature_set = tfidf_vectorizer.transform(
...
X_train, X_test, feature_transformer = extract_features(
    df, field, training_data, testing_data, type=feature_rep)
